...
class _$HomeStateTearOff {
  ...
  _Loaded loaded(HomeEntities data) {
    return _Loaded(
      data,
    );
  }
...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(HomeEntities data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(HomeEntities data)? loaded,
...
abstract class _Loaded implements HomeState {
  const factory _Loaded(HomeEntities data) = _$_Loaded;

  HomeEntities get data;
  @JsonKey(ignore: true)
